...
const foodSound=new Audio('snakeeat1.mp3');
const gameOverSound=new Audio('gameover.mp3');
const moveSound=new Audio('snakemove.mp3');
const musicSound=new Audio('snakesound.mp3');
let speed=7;
let lastPaintTime=0;
let snakeArr=[
    {x:13,y:15}
...
function gameEngine(){
    ...
    //if snake eaten food , increment the score AND regenerate the food
